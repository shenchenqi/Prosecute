...
final class CompatJsonpAndDataEmptyResponseBodyConverter<T> implements Converter<ResponseBody, T> {

    private static Logger logger = LoggerFactory.getLogger("CompatJsonpAndDataEmptyResponseBodyConverter");
    private final Converter<ResponseBody, T> converter;

    CompatJsonpAndDataEmptyResponseBodyConverter(Converter<ResponseBody, T> converter) {
