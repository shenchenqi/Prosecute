 ...
 */
public abstract class RootRom extends CreateRom {

    private static final Logger logger = Logger.getLogger("RomLog");
    private static final String TAG = "Root-Rom";

    protected RootRom(Context context, String packageName, String createDir) {
    ...
    public Looper getHandlerLooper(String name) {
    ...
    private class MIUI extends SystemUI {
        ...
        private MIUI(Context context, String manufacturer) {//huawei, meizu
            ...
            final Handler handler = RootRom.this.getHandler("copy_sub_handler");
